...
in addition to the title of the section.

Upstream: https://github.com/jterrace/sphinxtr/blob/master/extensions/numsec.py
"""
            ...
            if refdocname in secnums:
                ...
                for child in node.traverse():
                    if isinstance(child, nodes.Text):
                        ...
                        child.parent.replace(child, nodes.Text(linktext + " " + text))
